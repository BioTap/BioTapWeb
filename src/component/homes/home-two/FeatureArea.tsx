...
import bg_img from "@/assets/img/update/bg/feature-area-bg.png"
...
const FeatureArea = () => {
   return (
      <div className="feature-area-2 pt-110 pb-140 position-relative overflow-hidden" style={{ backgroundImage: `url(${bg_img.src})`, backgroundSize: "cover", backgroundPosition: "center" }} id="blockchain">
